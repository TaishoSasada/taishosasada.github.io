...
## ===Domestic Conference (国内研究会)===
 - <span style="color: red; ">[若手研究奨励賞]</span> 笹田 大翔, 妙中 雄三, 門林 雄基, "ゼロトラストアクセス制御のための行動的・認知的バイオメトリクスを用いたユーザ真正性検証手法", 電子情報通信学会技術研究報告(Web),  vol.122(No.362), pp. 19-24, 2023年1月
 ...
 - <span style="color: red; ">[学生奨励賞]</span> 笹田大翔, 馬場睦也, 木村優介, 波多野賢治, "データの複雑性を考慮した不均衡データに対するリサンプリング手法", 情報処理学会 第82回全国大会講演論文集, 2020年3月．
